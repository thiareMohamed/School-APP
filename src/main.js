...
{    // Creation des apprenant
    listeApprenants.insertAdjacentHTML(
        "beforeend",
        `
            <div class="carte-apprenant mb-3" id="${donnee.id}" onclick="showCarte(${donnee.id})" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                <div class="competences">
                    <div class="progress mb-3">
                        <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Front-end</div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 49%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Back-end</div>
                    </div>
                </div>
            </div>
        </div>
